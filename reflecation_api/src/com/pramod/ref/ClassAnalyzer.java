...
public class ClassAnalyzer {
	...
	public static PopupTypeInfo createPopupTypeInfoFromClass(Class<?> inputClass) {
		...
		popupTypeInfo.setPrimitive(inputClass.isPrimitive()).setInterface(inputClass.isInterface())
				.setEnum(inputClass.isEnum()).setName(inputClass.getSimpleName()).setJdk(isJdkClass(inputClass))
